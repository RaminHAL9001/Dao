...
-- Used internally to the 'LexBuilderState', particularly the 'stringToIDTable' field.
...
data LexBuilderState tok
  = LexBuilderState
    ...
    , stringToIDTable  :: M.Map UStr tok
...
-- instantiating your @'TokenType' tok@ into the 'Prelude.Show' class.
